...
def main():
   ...
   input_file = sc.textFile('/Dataset/Input/Parking_Violations_Demo.csv')
   ...
   tickets_2013.repartition(1).saveAsTextFile('/Demo/tickets_2013')     
   ...
   tickets_2014 = tickets.filter(lambda x: '2014' in x[4])\
                   ...
                   .sortByKey()	
   #save tickets on file				   
   tickets_2014.repartition(1).saveAsTextFile('/Demo/tickets_2014')     
   ...
   tickets_2015 = tickets.filter(lambda x: '2015' in x[4])\
                   ...
                   .sortByKey()	
   #save tickets on file				   
   tickets_2015.repartition(1).saveAsTextFile('/Demo/tickets_2015')   
   ...
   tickets_2016 = tickets.filter(lambda x: '2016' in x[4])\
                   ...
                   .sortByKey()	
   #save tickets on file				   
   tickets_2016.repartition(1).saveAsTextFile('/Demo/tickets_2016')
   ...
   tickets_2017 = tickets.filter(lambda x: '2017' in x[4])\
                   ...
                   .sortByKey()	
   #save tickets on file				   
   tickets_2017.repartition(1).saveAsTextFile('/Demo/tickets_2017')
